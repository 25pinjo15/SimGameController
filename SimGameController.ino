...
int sideAxe1 = 321;						// Placeholder for sideAxe 1 (rotary encoder)

int sideAxe2 = 654;						// Placeholder for sideAxe 2 (rotary encoder)
...
int sideAxe1LastPrint = 0; 				// Last value printed, used for fliker free
int sideAxe2LastPrint = 0; 				// Last value printed, used for fliker free
...
/* NOTE:
	-Page 1 : All 3 slider output.
	-Page 2 : All 2 side axes  output.
	-YOU NEED TO PUT EACH PAGE VARIABLE on intro and on other page for first print.
*/
...
void menu3()
{
	...
	// Page selection start here 	
	//_______________________________________________________________________________________

		//  =PAGE 1= Slider output show screen
	...
	//__________________________________________________________________________________________
		...
		if (menu3Page2Print == false) {					// Print only once
			...
			if (sideAxe1 != sideAxe1LastPrint) {
				lcd.setCursor(0,1);
				lcd.print("    ");
				lcd.setCursor(0,1);
				lcd.print(sideAxe1);
				sideAxe1LastPrint = sideAxe1;

			} 
		}

	}
	// Routine to navigate in page 
